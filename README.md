...
## 4.実験
### 4.1.データセット
**ICDAR2013(IC13)**は、高解像度画像、研修用画像229、英語テキストを含むテスト用テキスト233からなる、フォーカスシーンテキスト検出のための「Robust Reading Competition for Focusted spence text」の中でリリースされ、注釈は矩形ボックスを使用したワードレベルである。
